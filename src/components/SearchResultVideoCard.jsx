    ...
    <Link to={`/video/${video.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
          ...
          <span className=" empty:hidden text-sm line-clamp-1 md:line-clamp-2 text-white/[0.7]">
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex flex-col ">
              <span className=" font-semibold text-white/[0.7] flex items-center text-sm mt-2">
                {video?.author?.title}
